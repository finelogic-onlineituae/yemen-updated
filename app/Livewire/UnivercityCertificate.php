...
class UnivercityCertificate extends Component
{
    ...
    public $grade_statements;
    public $existing_grade_statements;
    public $countrys;
    ...
    protected function rules() 
    {
        return [
            ...
            'grade_statements' =>$this->existing_grade_statements ? 'nullable' :'required|file|mimes:pdf|max:2048',
        ];
    }
    protected $validationAttributes = [
        ...
        'id_card' => 'ID Card',
        'grade_statements' => 'Grade Statement',
    ];
    ...
    public function mount()
    {
        ...
        if(session()->has('edit_application') && session('edit_application') == 'university-certificate' && session()->has('application_id'))
        {
            ...
            $this->existing_grade_statements = $this->application->formable->grade_statements;
        }
    }
    ...
    public function registerApplication()
    {
        ...
        $this->dispatch('submitunivercityForm');
    }
    public function render()
    {
        return view('livewire.univercity-certificate');
    }
}

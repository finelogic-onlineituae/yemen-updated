<x-app-layout>
    ...
    <h3 class="text-success w-100 text-center">لتجديد جواز السفر للقُصَّر (أقل من 18 سنة)، يرجى تعبئة جميع الحقول الإلزامية لإتمام الطلب</h3>
    
<div>
    
    <div class="align-items-center text-center d-flex justify-content-center w-100 p-2 bg-form mh-100 h-100 ">
         <form action="{{ route('renew-passport-below.store') }}" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            @csrf
                ...
                <div class="card text-start my-2">
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                {{-- <div class="row">
                                <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        <label class="form-label fw-bold" for="father_name">اسم الأب</label>

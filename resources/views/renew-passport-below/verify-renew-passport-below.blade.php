...
<div>
    ...
    <div class="align-items-center text-center d-flex justify-content-center w-100 p-2 bg-form mh-100 h-100 ">
         <form action="@if(request()->has('edit')) {{ route('renew-passport-below.store', ['application' => $application->id]) }} @else {{ route('application.confirm', ['application_id' => $application->id]) }}  @endif" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            @csrf
                ...
                <div class="card text-start my-2">
                    ...
                    <div class="card-body">
                            ...
                            <!-- Modal -->
                                    <div id="passport" class="modal">
                                        <div class="modal-content">
                                            ...
                                            @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->passport->attachment }}"></iframe>
                                            @endif
                                        ...
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('emirate_id')">&times;</span>
                                             @if(Str::of($application->formable->emirates_id_attachment)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                        <img src="{{ $application->formable->emirates_id_attachment }}"
                                                            alt="Preview"
                                                            style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                                @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->emirates_id_attachment }}"></iframe>
                                            @endif
                                        </div>
                                    </div>
                                    <!-- End Modal -->
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                            <div @class(["d-none" => !request('edit'), "mb-2"])>
                                <label class="form-label fw-bold" for="father_emirate_id"> بطاقة هوية الأب (pdf ,jpg, png, jpeg)</label>
                                <input type="file" class="form-control" name="father_emirate_id"  @if(!request('edit')) disabled @endif/>
                                 @error('father_emirate_id') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                           <div>
                            <a onclick="openModal('father_emirate_id')" class="btn btn-dark">View Father Emirate ID</a>
                            <!-- Modal -->
                                    <div id="father_emirate_id" class="modal">
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('father_emirate_id')">&times;</span>
                                            @if(Str::of($application->formable->father_id_card)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                        <img src="{{ $application->formable->father_id_card }}"
                                                            alt="Preview"
                                                            style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                                @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->father_id_card }}"></iframe>
                                            @endif
                                        </div>
                                    </div>
                                    <!-- End Modal -->
                             ...
                             <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                <div @class(["d-none" => !request('edit'), "mb-2"])>
                                <label class="form-label fw-bold" for="mother_emirate_id">بطاقة هوية الأم (pdf ,jpg, png, jpeg)</label>
                                <input type="file" class="form-control" name="mother_emirate_id"  @if(!request('edit')) disabled @endif  />
                                @error('mother_emirate_id')<span class="text-danger">{{ $message }}</span> @enderror
                                 </div>
                           <div>
                            <a onclick="openModal('mother_emirate_id')" class="btn btn-dark">View Mother Emirate ID</a>
                            <!-- Modal -->
                                    <div id="mother_emirate_id" class="modal">
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('mother_emirate_id')">&times;</span>
                                            @if(Str::of($application->formable->mother_id_card)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                        <img src="{{ $application->formable->mother_id_card }}"
                                                            alt="Preview"
                                                            style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                                @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->mother_id_card }}"></iframe>
                                            @endif
                        ...
                        <div class="row">
                           ...
                           <div>
                            <a onclick="openModal('father_passport')" class="btn btn-dark">View Father Passport</a>
                            <!-- Modal -->
                                    <div id="father_passport" class="modal">
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('father_passport')">&times;</span>
                                            @if(Str::of($application->formable->father_passport)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                        <img src="{{ $application->formable->father_passport }}"
                                                            alt="Preview"
                                                            style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                                @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->father_passport }}"></iframe>
                                            @endif
                           ...
                           <div>
                            <a onclick="openModal('mother_passport')" class="btn btn-dark">View Mother Passport</a>
                            <!-- Modal -->
                                    <div id="mother_passport" class="modal">
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('mother_passport')">&times;</span>
                                            @if(Str::of($application->formable->mother_passport)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                        <img src="{{ $application->formable->mother_passport }}"
                                                            alt="Preview"
                                                            style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                                @else
                                                <iframe id="passport_iframe" src="{{ $application->formable->mother_passport }}"></iframe>
                                            @endif
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="relative_country" id="flexRadioDefault1" value="Yemen" @if(!request('edit')) disabled @endif    @checked($application->formable->relative_country == 'Yemen')>
                                            <label class="form-check-label" for="relative_country">
                                                Republic of Yemen
                                            </label>
                                            </div>
                                            <div class="form-check">
                                            <input class="form-check-input" type="radio" name="relative_country" id="flexRadioDefault2" value="UAE" @if(!request('edit')) disabled @endif   @checked($application->formable->relative_country == 'UAE')>
                                            <label class="form-check-label" for="relative_country">
                                                UAE
                                            </label>
                                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                              ...
                              <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="address_street" value="{{ $application->formable->street }}"  @if(!request('edit')) disabled @endif   required/>
            ...
            <div class="form-group my-3 text-center">
                ...
                @endif
                <a class="btn btn-dark" id="submitBtn" href="{{ route('renew-passport-below.verify', ['application_id' => $application->id, 'edit'=> true]) }}">قم بإجراء التغييرات</a>
            </div>
            </div>
            </div>
        </form>

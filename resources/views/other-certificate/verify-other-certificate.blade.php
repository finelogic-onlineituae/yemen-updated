<x-app-layout>
    ...
    <h2 class="text-success w-100 text-center">    شهادة أخرى</h2>
    <div>
            ...
            <div class="w-100 align-items-center text-center d-flex justify-content-center verfiy-form">
                ...
                <div class="form-group gap-2 my-3 text-center d-flex">
                    ...
                    {{-- <a href="#" class="btn btn-dark">Make Changes</a> --}}
                     <a href="{{ route('other-certificate.edit', ['application_id' => encrypt($application->id)]) }}" class="btn btn-dark">إجراء التغييرات</a>
                </div>
                </div>
            </div>
        </div>

<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="profile-update" >
            ...
            <input id="email" name="email" type="email" style="direction: rtl; text-align: right;" class="mt-1 block w-full form-control" value="{{$user->email}}" required autocomplete="username" />

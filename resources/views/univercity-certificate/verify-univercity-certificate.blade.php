            ...
            <div class="w-100 align-items-center text-center d-flex justify-content-center verfiy-form">
                ...
                <div class="manage-width-75 manage-width p-3 mx-2 rounded  align-items-center text-center  bg-ash ">
                    ...
                    <div class="card-body text-start">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        <span><button class="btn btn-dark me-2 rounded-5" onclick="openModal('pdfModal-verify-id-card')"> بطاقة الهوية(  ملف بي دي إف )</button></span>
                                        <!-- Modal -->
                                        <div id="pdfModal-verify-id-card" class="modal">
                                            <div class="modal-content">
                                                <span class="close" onclick="closeModal('pdfModal-verify-id-card')">&times;</span>
                                                <iframe id="pdfViewer-verify-id-card" src="{{ generate_signed_storage_url($application->formable->id_card) }}"></iframe>
                                            </div>
                                        </div>
                                        <!-- End Modal -->
                                </div>
                        ...
                        <div class="row">
                           ...
                           <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        <span><button class="btn btn-dark me-2 rounded-5" onclick="openModal('pdfModal-verify-grade_statements')">بيان الصف(  ملف بي دي إف )</button></span>
                                        <!-- Modal -->
                                        <div id="pdfModal-verify-grade_statements" class="modal">
                                            <div class="modal-content">
                                                ...
                                                <iframe id="pdfViewer-verify-grade_statements" src="{{ generate_signed_storage_url($application->formable->grade_statements) }}"></iframe>
                                            </div>
                                        </div>
                                        <!-- End Modal -->
                                </div>
                ...
                <div class="form-group gap-2 my-3 text-center d-flex">
                    ...
                    {{-- <a href="#" class="btn btn-dark">Make Changes</a> --}}
                     <a href="{{ route('university-certificate.edit', ['application_id' => encrypt($application->id)]) }}" class="btn btn-dark">إجراء التغييرات</a>
                </div>
                </div>
            </div>
        </div>

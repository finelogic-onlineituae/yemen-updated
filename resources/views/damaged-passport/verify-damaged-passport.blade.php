<x-app-layout>
    ...
    <h2 class="text-success w-100 text-center">جواز السفر التالف</h2>
    <div>
            ...
            <div class="w-100 align-items-center text-center d-flex justify-content-center verfiy-form">
                ...
                <div class="manage-width-75 manage-width p-3 mx-2 rounded  align-items-center text-center form-scroll bg-ash ">
                    ...
                    <div class="card-body text-start">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                <span class="fw-bold"> Reason for Damage </span>
                                <span>:{{ $application->formable->damage_reason }}</span>
                            </div>
                            {{-- <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                             ...
                             {{-- <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                <span><button class="btn btn-dark me-2 rounded-5" onclick="openModal('pdfModal-verify-id_card')">id_card  </button></span>
                                <!-- Modal -->
                ...
                <div class="form-group gap-2 my-3 text-center d-flex">
                    ...
                    {{-- <a href="#" class="btn btn-dark">Make Changes</a> --}}
                     <a href="{{ route('damaged-passport.edit', ['application_id' => encrypt($application->id)]) }}" class="btn btn-dark">إجراء التغييرات</a>
                </div>
                </div>
            </div>
        </div>

...
<div>
    ...
    <div class="align-items-center text-center d-flex justify-content-center w-100 p-2 bg-form mh-100 h-100 ">
         <form action="@if(request()->has('edit')) {{ route('damaged-passport.store', ['application' => $application->id]) }} @else {{ route('application.confirm', ['application_id' => $application->id]) }}  @endif" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            @csrf
                            ...
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12" id="preview-crop" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" min="1900-01-01" max="2099-12-31" name="issued_on" value="{{ $application->formable->passport->issued_on }}"  @if(!request('edit')) disabled @endif  required/>
                                    ...
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" min="1900-01-01" max="2099-12-31" id="expire_on" name="expire_on"  value="{{ $application->formable->passport->expires_on }}"  @if(!request('edit')) disabled @endif   required/>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                        <label class="form-label fw-bold" for="damage_reason">إيضاح سبب تلف جواز السفر</label>
                                        <input type="text" class="form-control" name="damage_reason" value="{{ $application->formable->damage_reason }}"  @if(!request('edit')) disabled @endif   required/>
                                        @error('damage_reason')<span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                            </div>
            ...
            <div class="form-group my-3 text-center">
                ...
                @endif
                <a class="btn btn-dark" id="submitBtn" href="{{ route('damaged-passport.verify', ['application_id' => $application->id, 'edit'=> true]) }}">قم بإجراء التغييرات</a>
            </div>
            </div>
            </div>
        </form>

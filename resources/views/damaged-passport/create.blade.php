<x-app-layout>
    ...
    <h3 class="text-success w-100 text-center" >لإصدار جواز سفر بدل تالف، يرجى تعبئة جميع الحقول الإلزامية لإتمام الطلب</h3>
         ...
         <form action="{{ route('damaged-passport.store') }}" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            ...
            <div class="manage-width-75 manage-width p-3 mx-2 rounded  align-items-center text-center form-scroll bg-ash ">
                <div class="card text-start my-2">
                    @if(session('old_passport') != null)
                        <div class="alert alert-danger">
                            {{ session('old_passport') }}
                        </div>
                    @endif
                    @if ($errors->any())
                            <div class="alert alert-danger">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" min="1900-01-01" max="2099-12-31" name="issued_on" value="{{ old('issued_on') }}" required/>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="damage_reason" value="{{ old('damage_reason') }}" required/>

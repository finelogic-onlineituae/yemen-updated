...
<div>
    ...
    <div class="align-items-center text-center d-flex justify-content-center w-100 p-2 bg-form mh-100 h-100 ">
         <form action="@if(request()->has('edit')) {{ route('attestation.store', ['application' => $application->id]) }} @else {{ route('application.confirm', ['application_id' => $application->id]) }}  @endif" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                        <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{ $application->formable->name }}" @if(!request('edit')) disabled @endif required/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="tel" class="form-control" name="phone_number" @if(!request('edit')) disabled @endif value="{{ $application->formable->phone_number }}" @if(!request('edit')) disabled @endif required/>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <div>
                                            <a onclick="openModal('passport_attachment')" class="btn btn-dark">View Emirate ID</a>
                                                    <!-- Modal -->
                                    ...
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <div>
                                            <a onclick="openModal('emirate_id_attachment')" class="btn btn-dark">View Emirate ID</a>
                                                    <!-- Modal -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="document_type" value="{{ $application->formable->document_type }}" @if(!request('edit')) disabled @endif required/>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3 mb-lg-0 mb-md-0">
                                            ...
                                            <select name="issuing_country" class="form-select" @if(!request('edit')) disabled @endif >
                                                <option value="">Choose Country</option>
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}" @selected($country->id == $application->formable->issuing_country)>{{ $country->country_name }}</option>
                                                @endforeach
                                            </select>
                                            @error('issued_by') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="document_issuing_authority" value="{{ $application->formable->issuing_authority }}" @if(!request('edit')) disabled @endif required/>
                                    ...
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <div>
                                            <a onclick="openModal('document_attachment')" class="btn btn-dark">View Emirate ID</a>
                                                    <!-- Modal -->
                                                    <div id="document_attachment" class="modal">
                                                        <div class="modal-content">
            ...
            <div class="form-group my-3 text-center">
                ...
                @endif
                <a class="btn btn-dark" id="submitBtn" href="{{ route('attestation.verify', ['application_id' => $application->id, 'edit'=> true]) }}">قم بإجراء التغييرات</a>
            </div>
            </div>
            </div>
        </form>

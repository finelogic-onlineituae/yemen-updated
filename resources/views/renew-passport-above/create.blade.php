<x-app-layout>
    ...
    <h3 class="text-success w-100 text-center" >لتجديد جواز السفر للبالغين (18 سنة فأكثر)، يرجى تعبئة جميع الحقول الإلزامية لإتمام الطلب.</h3>
    
<div>
    
    <div class="align-items-center text-center d-flex justify-content-center w-100 p-2 bg-form mh-100 h-100 ">
         <form action="{{ route('renew-passport-above.store') }}" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            @csrf

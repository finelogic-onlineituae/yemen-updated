         ...
         <form action="@if(request()->has('edit')) {{ route('driving-licence.store', ['application' => $application->id]) }} @else {{ route('application.confirm', ['application_id' => $application->id]) }}  @endif" enctype="multipart/form-data" method="POST" id="renew-passport-above-form" class="w-100 align-items-center text-center d-flex justify-content-center">
            ...
            <div class="manage-width-75 manage-width p-3 mx-2 rounded  align-items-center text-center form-scroll bg-ash ">
                <div class="card text-start my-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" id="expire_on" min="1900-01-01" max="2099-12-31" name="expire_on"  value="{{ $application->formable->passport->expires_on }}"  @if(!request('edit')) disabled @endif   required/>
                    ...
                    <div class="card">
                        <div class="card-header">بيانات رخصة القيادة</div>   
                   <div class="card-body">
                        <div class="row">
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                ...
                                <input type="date" class="form-control" name="dl_issued_on" min="1900-01-01" max="2099-12-31" value="{{  $application->formable->dl_issued_on }}"   @if(!request('edit')) disabled @endif  />
                            ...
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                ...
                                <input type="date" class="form-control" name="dl_expire_on" min="1900-01-01" max="2099-12-31" value="{{$application->formable->dl_expire_on }}"   @if(!request('edit')) disabled @endif  />
                ...
                <div class="card text-start my-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                            <div @class(["d-none" => !request('edit'), "mb-2"])>
                                <label class="form-label fw-bold" for="driving_licence"> جواز (ملف بي دي إف  ,jpg, png, jpeg)</label>
                                <input type="file" class="form-control" name="driving_licence"  @if(!request('edit')) disabled @endif/>
                                 @error('driving_licence') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                           <div>
                            <a onclick="openModal('licence')" class="btn btn-dark">View Driving Licence</a>
                            <!-- Modal -->
                                    <div id="licence" class="modal">
                                        <div class="modal-content">
                                            <span class="close" onclick="closeModal('licence')">&times;</span>
                                            @if(Str::of($application->formable->driving_licence_attachment)->lower()->endsWith(['.jpg', '.jpeg', '.png', '.webp']))
                                                    <img src="{{ $application->formable->driving_licence_attachment }}"
                                                        alt="Preview"
                                                        style="max-width: 100%;aspect-ratio: 1 / 1;object-fit: cover; max-height: 100%; object-fit: contain; border-radius: 6px;">
                                            @else
                                            <iframe id="passport_iframe" src="{{ $application->formable->driving_licence_attachment }}"></iframe>
                                            @endif
